...
// typedef void (*error_callback_t)(const ERROR_CTX_t* error_ctx); // application function called when declaring an
// error typedef void (*error_reboot_callback_t)(const ERROR_CTX_t* error_ctx); // application function called after
// boot with pointer to RAM array
