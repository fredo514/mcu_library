...
extern void test_start_here(void);
 ...
 int main(int argc, char** argv)
{
  ...
  if (parse_status != 0)
  {
    if (parse_status < 0)
    {
      UnityPrint("test_dm_registry.");
      UNITY_PRINT_EOL();
      UnityPrint("  test_start_here");
      UNITY_PRINT_EOL();
      return 0;
    }
    return parse_status;
...
#endif
  UnityBegin("test_dm_registry.c");
  run_test(test_start_here, "test_start_here", 15);
